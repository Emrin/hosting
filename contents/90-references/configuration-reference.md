...
## Platform's Services
*Platform's services configuration*

### Common App Configuration
*Defines common configuration for all the services*
...
| `SCHEDULER_SETUP_ON_STARTUP` | Optional ☑️ | (boolean) Starts setup of backing services on startup. Defaults to `true` |
...
*Required backing services configuration*
...
*Optional backing services that can be used to enhance the platform capabilities.*
...
*Connected apps service configuration*
...
| `AUDIT_SERVICE_PORT` | Optional ☑️ | (number) Auditing service port. Defaults to `8010`. |
...
| `ANALYTICS_SERVICE_SETUP_APPLICATION_DB_CLIENT` | Optional ☑️ | (string) Database engine client among `mysql` / `mariadb` / `postgres` / `mssql` (Currently only `postgres` is officially supported). Defaults to `postgres`. |
| `ANALYTICS_SERVICE_SETUP_APPLICATION_DB_DIALECT_OPTIONS` | Optional ☑️ | (string) Database engine specific dialect options as a stringified json. Defaults to `{"ssl": false}`. |
| `ANALYTICS_SERVICE_SETUP_APPLICATION_DB_HOST` | Optional ☑️ | (string) Database server host. Defaults to `localhost`. |
| `ANALYTICS_SERVICE_SETUP_APPLICATION_DB_PORT` | Optional ☑️ | (number) Database server port. Defaults to `5432`. |
| `ANALYTICS_SERVICE_SETUP_APPLICATION_DB_SSL_MODE` | Optional ☑️ | (string) Specify ssl policy. Defaults to `require`. |
| `ANALYTICS_SERVICE_SETUP_APPLICATION_DB_DATABASE_NAME` | Optional ☑️ | (string) Database name. Defaults to `st_audit_db`. |
| `ANALYTICS_SERVICE_SETUP_APPLICATION_DB_USER` | Optional ☑️ | (string) Database user name. Defaults to `st_audit_db_user`. |
| `ANALYTICS_SERVICE_SETUP_APPLICATION_DB_PASSWORD` | Optional ☑️ | (string) Database password. Defaults to `st_audit_db_password`. |
| `ANALYTICS_SERVICE_SETUP_AUDIT_DB_CLIENT` | Optional ☑️ | (string) Database engine client among `mysql` / `mariadb` / `postgres` / `mssql` (Currently only `postgres` is officially supported). Defaults to `postgres`. |
| `ANALYTICS_SERVICE_SETUP_AUDIT_DB_DIALECT_OPTIONS` | Optional ☑️ | (string) Database engine specific dialect options as a stringified json. Defaults to `{"ssl": false}`. |
| `ANALYTICS_SERVICE_SETUP_AUDIT_DB_HOST` | Optional ☑️ | (string) Database server host. Defaults to `localhost`. |
| `ANALYTICS_SERVICE_SETUP_AUDIT_DB_PORT` | Optional ☑️ | (number) Database server port. Defaults to `5432`. |
| `ANALYTICS_SERVICE_SETUP_AUDIT_DB_SSL_MODE` | Optional ☑️ | (string) Specify ssl policy. Defaults to `require`. |
| `ANALYTICS_SERVICE_SETUP_AUDIT_DB_DATABASE_NAME` | Optional ☑️ | (string) Database name. Defaults to `st_audit_db`. |
| `ANALYTICS_SERVICE_SETUP_AUDIT_DB_USER` | Optional ☑️ | (string) Database user name. Defaults to `st_audit_db_user`. |
| `ANALYTICS_SERVICE_SETUP_AUDIT_DB_PASSWORD` | Optional ☑️ | (string) Database password. Defaults to `st_audit_db_password`. |
...
| `SEARCH_SERVICE_HOST` | Optional ☑️ | (string) Search service host. Defaults to "". |
| `SEARCH_SERVICE_PORT` | Optional ☑️ | (string) Search service port. Defaults to "20001". |
...
| Environment Variable | Status | Description |
|:---------------------|:-------|:------------|
| `MICROSOFT_COMMERCIAL_MARKETPLACE_INTEGRATION_ENABLED` | Optional ☑️ | (boolean) Enable integration with the Microsoft Marketplace. Defaults to "false". |
| `MICROSOFT_COMMERCIAL_MARKETPLACE_LANDING_PAGE_URL` | Optional ☑️ | (string) URL of the Microsoft Marketplace landing page. Defaults to `http://localhost/microsoft-marketplace/order`. |
| `MICROSOFT_COMMERCIAL_MARKETPLACE_CONNECTION_WEBHOOK_URL` | Optional ☑️ | (string) URL of the Microsoft Marketplace webhook URL. Defaults to `http://localhost/api/v1.0/microsoft_marketplace/notifications_handler`. |
| `MICROSOFT_COMMERCIAL_MARKETPLACE_TENANT_ID` | Optional ☑️ | (string) Tenant ID used for authentication to the Microsoft Marketplace landing page. Defaults to `""`. |
| `MICROSOFT_COMMERCIAL_MARKETPLACE_FRONTEND_APP_ID` | Optional ☑️ | (string) Microsoft Azure client ID used for authentication to the Microsoft Marketplace landing page. Defaults to `""`. |
| `MICROSOFT_COMMERCIAL_MARKETPLACE_FRONTEND_APP_SECRET` | Optional ☑️ | (string) Secret instrumentation key used server-side to authenticate against the Microsoft Marketplace Front-end service. Defaults to `""`. |
| `MICROSOFT_COMMERCIAL_MARKETPLACE_BACKEND_APP_ID` | Optional ☑️ | (string) Microsoft Azure client ID used for interactions with the Microsoft Marketplace API. Defaults to `""`. |
| `MICROSOFT_COMMERCIAL_MARKETPLACE_BACKEND_APP_SECRET` | Optional ☑️ | (string) Secret instrumentation key used server-side to authenticate against the Microsoft Marketplace back-end service. Defaults to `""`. |
| `MICROSOFT_COMMERCIAL_MARKETPLACE_PUBLISHER_ID` | Optional ☑️ | (string) Publisher ID from the Microsoft Marketplace registration. Defaults to `""`. |
| `MICROSOFT_COMMERCIAL_MARKETPLACE_OFFER_ID` | Optional ☑️ | (string) Offer ID from the Microsoft Marketplace registration. Defaults to `""`. |
...
| Environment Variable | Status | Description |
|:---------------------|:-------|:------------|
| `WEBHOOKS_USER_AGENT` | Optional ☑️ | (string) HTTP user agent passed as a header with each request. Defaults to `nBold-Webhook/v5.3.0`. |
